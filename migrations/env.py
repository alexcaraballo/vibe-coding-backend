...
# Import all SQLAlchemy models here for auto-detection
...
# from apps.matching.infrastructure.models import MatchResultModel
# from apps.maps.infrastructure.models import RouteModel
